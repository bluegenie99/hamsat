...
const ImageEditor: React.FC<ImageEditorProps> = ({ image, onSave, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 z-50 flex items-center justify-center overflow-y-auto p-4">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl w-full max-w-4xl my-8">
        {/* رأس المحرر */}
        <div className="p-4 bg-gradient-to-r from-pink-500 to-purple-500 text-white rounded-t-lg sticky top-0 z-10">
          <h2 className="text-xl font-bold">تعديل الصورة</h2>
        </div>
        
        {/* محتوى المحرر */}
        <div className="p-6 overflow-y-auto" style={{ maxHeight: '65vh', minHeight: '500px' }}>
        ...
        <div className="p-4 bg-gray-100 dark:bg-gray-700 flex justify-end space-x-2 rtl:space-x-reverse border-t border-gray-200 dark:border-gray-700 rounded-b-lg sticky bottom-0 z-10">
          <button
            onClick={onCancel}
